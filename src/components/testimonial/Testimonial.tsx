...
import avatar_img from "@/shared/assets/img/avatar_1.jpg";
import testimonial_thumb from "@/shared/assets/img/testimonial_thumb_1.jpg";
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-4">
              <div>
                <AppImage src={testimonial_thumb} alt="" className="w-100" />
              </div>
            </div>
                      ...
                      <div className="cs_testimonial_box">
                        ...
                        <div className="cs_testimonial_meta">
                          <div className="cs_testimonial_avatar">
                            {/* <AppImage src={item.img} alt="Avatar" /> */}
                          </div>
