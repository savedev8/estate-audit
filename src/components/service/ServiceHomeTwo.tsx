        ...
        <div className="container">
          ...
          <div className="row cs_cr_pr cs_row_gap_150">
                  ...
                  <div key={i} className="cs_creative_protfolio cs_card_style_change">
                    <div className="cs_card cs_style_1 cs_color_1">
                      <div className="cs_card_right">
                        <div className="cs_card_right_in">
                          <h2 className="cs_card_title">
                            <Link to="/service-details" className="cs_white_color">
                      ...
                      <div className="cs_card_link_wrap">
                        <Link to="/service-details" className="cs_card_link cs_white_color">
                          <span>
            ...
            <div className="col-md-6 mb-4">
              <div className="h-100">
                <AppImage src={bg_img} className="w-100 h-100 anim_div_ShowRightSide" alt="cp_services" />
              </div>
            </div>
          </div>
        </div>
