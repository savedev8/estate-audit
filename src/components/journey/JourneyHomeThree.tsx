        ...
        <div className="container">
          <div className="cs_journey_stary">
            ...
            <h2 className="cs_line_height_85 anim_text">
              Welcome to
              <span><AppImage src={journey_img_1} alt="Journey_story_1" /></span> our design
              studio! We create visually stunning designs
              <span><AppImage src={journey_img_2} alt="Journey_story_2" /></span> for print,
              digital
              <span><AppImage src={journey_img_3} alt="Journey_story_3" /></span> ndenvironmental
              mediums. Let's bring your vision to
              <span><AppImage src={journey_img_4} alt="Journey_story_4" /></span> life together
            </h2>
          </div>
        </div>
      </section>
