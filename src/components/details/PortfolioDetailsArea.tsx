    ...
    <>
        ...
        <div className="container">
          <div className="cs_portfolio_details">
            <div className="reveal">
              <AppImage src={protfolio_details_1} alt="protfolio_details_1" />
            </div>
            <div className="cs_height_100 cs_height_lg_60"></div>
      ...
      <div className="container">
        <div className="d-flex gap-2 gap-md-5">
          <div className="reveal">
            <AppImage src={protfolio_details_2} alt="portfoliodetails_2" />
          </div>
          <div className="reveal">
            <AppImage src={protfolio_details_3} alt="portfoliodetails_1" />
          </div>
        </div>
      </div> 
              ...
              <div className="cs_solutions_section anim_div_ShowDowns">
                ...
                <div className="cs_solutions_section_img_show">
                  <div className="portfolio_solution_1 reveal">
                    <AppImage src={protfolio_details_4} alt="portfolio_solution_1" />
                  </div>
                  <div className="portfolio_solution_2 reveal">
                    <AppImage src={protfolio_details_5} alt="portfolio_solution_2" />
                  </div>
                  <div className="portfolio_solution_3 reveal">
                    <AppImage src={protfolio_details_6} alt="portfolio_solution_3" />
                  </div>
                </div>
