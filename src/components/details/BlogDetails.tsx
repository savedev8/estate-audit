...
const blog_details_content = {
  title: `Принимаем квартиру`,
  info: [
    { title: `Posted By`, des: `Andrew Nikulas` },
    { title: `Published Date`, des: `02 - Dec - 2023` },
    { title: `Viewes`, des: `2 Min Read` },
  ],
  title_2: `Что необходимо учесть при приёмке квартиры?`,
  des_1: `После того как переход права собственности зарегистрирован и оплата проведена, нужно принять квартиру. При этом обязательно необходимо:`,
  features: [
    `Cверить все показания счетчиков с данными в квитанциях, даже если вам показывают справку из бухгалтерии;`,
    `Прием-передачу лучше производить по заранее согласованному акту приема-передач;`,
    `При соблюдении всех условий и надлежащем состоянии объекта обе стороны подписывают документы и передают ключи;`,
  ],
  ...
  qute: `Если квартира продается с мебелью, кондиционером и другими движимыми вещами, это нужно указать в договоре. Подойдет фраза: «Имущество продавца, находящееся в квартире в день ее передачи покупателю, переходит в собственность покупателя, цена такого имущества включена в стоимость квартиры». Лучше всего описать это имущество в договоре или акте приема-передачи.`,
...
export const BlogDetails = () => {
  return (
    <>
        ...
        <div className="container">
          <div className="cs_portfolio_details">
            {/* <div className="reveal">
              <AppImage src={blog_detaisl_img_1} alt="blog_detals_banner" />
            </div> */}
      ...
      {/* секция расположения картинок, переиспользуемая */}
      {/* <div className="container">
        <div className="cs_img_box cs_style_1">
          <div className="cs_img_show">
            <div className="cs_img_1 reveal">
              <AppImage src={blog_details_1} alt="blog_details_1" />
            </div>
            <div className="cs_img_2 reveal">
              <AppImage src={blog_details_2} alt="blog_details_2" />
            </div>
          </div>
          <div className="cs_height_30 cs_height_lg_30"></div>
          <div className="cs_img_show">
            <div className="cs_img_3 reveal">
              <AppImage src={blog_details_3} alt="blog_details_3" />
            </div>
            <div className="cs_img_4 reveal">
              <AppImage src={blog_details_4} alt="blog_details_4" />
            </div>
          </div>
        </div>
      ...
      {/* секция социальных сетей переиспользуемая */}
      {/* <div className="container">
        <div className="row">
      ...
      {/* классная секция для комментов в блоге, переиспользуемая */}
      {/* <section>
        <div className="container">
          <div className="row">
            <div className="col-lg-6">
              <div className="anim_div_ShowDowns">
                <div>
                  ...
                  <div className="cs_height_30 cs_height_lg_30"></div>
                  <p className="cs_m0">
                    No Comment Yet! Estate Audit post comment box is empty!
                  </p>
                  <div className="cs_height_30 cs_height_lg_30"></div>
