...
import portfolio_img_1 from '@/shared/assets/img/portfolio_1.jpg';
import portfolio_img_2 from '@/shared/assets/img/portfolio_2.jpg';
import portfolio_img_3 from '@/shared/assets/img/portfolio_3.jpg';
          ...
          {portfolio_slider.map((item, i) =>
            <SwiperSlide key={i} className="swiper-slide">
              <div className="cs_horizontal_scroll">
                <Link to="/portfolio-details" className="cs_portfolio cs_style_1">
