            ...
            <div className="cs_marketing_agency_section cs_style_1">
              <div className="cs_text_img">
                ...
                <div className="cs_img">
                  <AppImage src={dm_banner} alt="Dmbanner" />
                </div>
              </div>
              ...
              <div className="cs_text_btn anim_div_ShowDowns">
                <div className="cs_hero_btn_wrap">
                  <div className="cs_round_btn_wrap">
                    <Link to="/portfolio" className="cs_hero_btn cs_round_btn btn-item"><span></span>
                      {bt_text}
                    </Link>
                  </div>
                </div>
            ...
            <div className="cs_icon_img social_link">
              {social_links.map((item, i) =>
                <a key={i} href={item.link} target='_blank'>
                  <AppImage src={`${item.img}`} alt="fb_1" className={`${i === 1 ? "social_link_style" : ""}`} />
                </a>
              )}
            </div>
          </div>
